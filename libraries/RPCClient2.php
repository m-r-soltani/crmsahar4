...
class RPCClient
{
    ...
    {
        $this->httpClient = $httpClient ?: new RPCHttpClient($url);
     ...
     * @throws Exception
     */
    public function execute($procedure, array $params = [], $requestId = null, array $headers = [])
    {
        $payload = RPCRequestBuilder::create()
    ...
    {
        return RPCResponseParser::create()
