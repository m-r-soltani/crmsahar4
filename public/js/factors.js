$(document).ready(function () {
    ...
    DATEPICKER_YYYYMMDD('#sj_bs_tarikhe_shoroe_service');
    ...
    $("#bs_tab_link").on('click', function () {
        ...
        // ajaxRequest('GetActiveAsiatechBitstreamServicesOfUser', {'subid': user_id}, window.location.href.split('/').slice(-1)[0], function (res) {
        //     console.log(res);
        //     if(check_isset_message(res)){
        //         display_Predefiend_Messages(res);
        //     }else{
                ...
                sj_bs_telephone.on('change', function () {
                    ...
                    get_servicesbybsreserveid(bor_id, function (data) {
                        ...
                        if (check_isset_message(data)) {
                            ...
                            ajaxRequest('checkprevfactor', { 'subid': user_id, 'emkanatid': bor_id, 'servicetype': 'bitstream' }, window.location.href.split('/').slice(-1)[0], function (rescheckprevfactor) {
                                            ...
                                            sefareshe_jadid_serviceslist_li.on('click', function () {
                                                ...
                                                for (let i = 0; i < data.length; i++) {
                                                    if (data[i] && data[i]['id'] === int_li_id) {
                                                        ...
                                                        $('#sj_bs_tarikhe_payane_service').val(data[i]['tarikhe_payane_service']);
                                                        ...
                                                        if (takhfif !== 0 && takhfif !== null && takhfif !== '' && takhfif !== undefined && takhfif !== NaN && takhfif !== 'undefined') {
                                                            ...
                                                            $('#sj_bs_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                            $('#sj_bs_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                            $('#sj_bs_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                                            $('#sj_bs_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                            $('#sj_bs_hazine_ranzhe').val((data[i]['hazine_ranzhe']));
                                                            $('#sj_bs_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                            $('#sj_bs_hazine_dranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_dranzhe'],0)));
                                                            $('#sj_bs_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                            $('#sj_bs_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                                            $('#sj_bs_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                                            ...
                                                            $('#sj_bs_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                                            $('#sj_bs_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                            $('#sj_bs_hazine_ranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_ranzhe'],0)));
                                                            $('#sj_bs_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                            $('#sj_bs_hazine_dranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_dranzhe'],0)));
                                                            $('#sj_bs_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                            $('#sj_bs_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                        ...
                                        sefareshe_jadid_serviceslist_li.on('click', function () {
                                            ...
                                            for (let i = 0; i < data.length; i++) {
                                                if (data[i] && data[i]['id'] === int_li_id) {
                                                    ...
                                                    $('#sj_adsl_zamane_estefade').val(data[i]['zaname_estefade']);
                                                    data[i]['tarikhe_shoroe_namayesh'] = tabdile_tarikh_adad(data[i]['tarikhe_shoroe_namayesh']);
                                                    data[i]['tarikhe_payane_namayesh'] = tabdile_tarikh_adad(data[i]['tarikhe_payane_namayesh']);
                                                    ...
                                                    if (! isEmpty(takhfif)) {
                                                        ...
                                                        darsade_avarez_arzeshe_afzode = Float_Round(darsade_avarez_arzeshe_afzode, 2);
                                                        darsade_maliate_arzeshe_afzode = Float_Round(darsade_maliate_arzeshe_afzode, 2);
                                                        $('#sj_adsl_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                        $('#sj_adsl_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                        $('#sj_adsl_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(parseInt(gheymat_nahai),0)));
                                                        $('#sj_adsl_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                        $('#sj_adsl_hazine_ranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_ranzhe'],0)));
                                                        $('#sj_adsl_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                        $('#sj_adsl_hazine_dranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_dranzhe'],0)));
                                                        $('#sj_adsl_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                        $('#sj_adsl_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                                        $('#sj_adsl_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                                        ...
                                                        $('#sj_adsl_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                        $('#sj_adsl_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                        $('#sj_adsl_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                                        $('#sj_adsl_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                        $('#sj_adsl_hazine_ranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_ranzhe'],0)));
                                                        $('#sj_adsl_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                        $('#sj_adsl_hazine_dranzhe').val(numberWithCommas(Getor_String(data[i]['hazine_dranzhe'],0)));
                                        ...
                                        for (let i = 0; i < data.length; i++) {
                                            if (data[i] && data[i]['id'] === int_li_id) {
                                                ...
                                                if (! isEmpty(takhfif)) {
                                                    ...
                                                    // gheymat_nahai = parseFloat(gheymat_nahai + darsade_avarez_arzeshe_afzode + darsade_maliate_arzeshe_afzode);
                                                    // gheymat_nahai = Float_Round(gheymat_nahai, 2);
                                                    $('#sj_wireless_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                    $('#sj_wireless_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                    $('#sj_wireless_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                                    $('#sj_wireless_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                    $('#sj_wireless_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                    $('#sj_wireless_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                    $('#sj_wireless_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                                    $('#sj_wireless_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                        ...
                                        for (let i = 0; i < data.length; i++) {
                                            if (data[i] && data[i]['id'] === int_li_id) {
                                                ...
                                                if (! isEmpty(takhfif)) {
                                                    ...
                                                    // gheymat_nahai = parseFloat(gheymat_nahai + darsade_avarez_arzeshe_afzode + darsade_maliate_arzeshe_afzode);
                                                    // gheymat_nahai = Float_Round(gheymat_nahai, 2);
                                                    $('#sj_tdlte_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                    $('#sj_tdlte_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                    $('#sj_tdlte_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(parseInt(gheymat_nahai,0))));
                                                    $('#sj_tdlte_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                    $('#sj_tdlte_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                    $('#sj_tdlte_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                    $('#sj_tdlte_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                                    $('#sj_tdlte_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                                    ...
                                                    $('#sj_tdlte_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                                    $('#sj_tdlte_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                                    $('#sj_tdlte_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                                    $('#sj_tdlte_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                                    $('#sj_tdlte_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                                    $('#sj_tdlte_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                                    $('#sj_tdlte_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                            ...
                            for (let i = 0; i < data.length; i++) {
                                if (data[i] && data[i]['id'] === int_li_id) {
                                    ...
                                    if (takhfif !== 0 || takhfif !== null || takhfif !== '' || takhfif !== undefined || takhfif !== NaN || takhfif !== 'undefined') {
                                        ...
                                        // gheymat_nahai = parseFloat(gheymat_nahai + darsade_avarez_arzeshe_afzode + darsade_maliate_arzeshe_afzode);
                                        // gheymat_nahai = Float_Round(gheymat_nahai, 2);
                                        $('#sj_voip_darsade_avareze_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_avarez_arzeshe_afzode,0)));
                                        $('#sj_voip_maliate_arzeshe_afzode').val(numberWithCommas(Getor_String(darsade_maliate_arzeshe_afzode,0)));
                                        $('#sj_voip_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                        $('#sj_voip_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                        $('#sj_voip_hazine_nasb').val(numberWithCommas(Getor_String(Getor_String(data[i]['hazine_nasb'],0))));
                                        $('#sj_voip_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                        $('#sj_voip_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                        $('#sj_voip_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                        $('#sj_voip_subscriber_id').val(user_id);
                                        ...
                                        $('#sj_voip_mablaghe_ghabele_pardakht').val(numberWithCommas(Getor_String(gheymat_nahai,0)));
                                        $('#sj_voip_takhfif').val(numberWithCommas(Getor_String(takhfif,0)));
                                        $('#sj_voip_hazine_nasb').val(numberWithCommas(Getor_String(data[i]['hazine_nasb'],0)));
                                        $('#sj_voip_abonmane_port').val(numberWithCommas(Getor_String(data[i]['port'],0)));
                                        $('#sj_voip_abonmane_faza').val(numberWithCommas(Getor_String(data[i]['faza'],0)));
                                        $('#sj_voip_abonmane_tajhizat').val(numberWithCommas(Getor_String(data[i]['tajhizat'],0)));
                                        $('#sj_voip_subscriber_id').val(user_id);
