$(document).ready(function () {
    ...
    meliat.on('change',function(){
        ...
        //////////////////////__EST AUTH/////////////////////////////
        $('#estauth').click(function() {
            let tr = $('#view_table tbody').find('tr.selected');
            let td = tr.find('td:first').text();
            ajaxRequest('estauthsub', {'subid':td}, window.location.href.split('/').slice(-1)[0], function(result){
                if(check_isset_message(result)){
                    display_Predefiend_Messages(result);
                }
            });
    ...
    DataTable5('#view_table', /*url*/ 'legal_subscribers', /*request(dont change)*/ 'datatable_request', /*request*/ 'legal_subscribers', /*filter*/ '', /*filter2*/ '', '', 'POST', cols, function (table) {
        /*===================++  hide first column ++=========================*/
