...
class Administration_Change_Service_Password extends Controller
{
    ...
    {
        /*========sabte shahr========*/
        // if (isset($_POST['send_administration_change_service_password'])) {
        ...
        // }
        $this->view->pagename = 'administration_change_service_password';
        $this->view->render('administration_change_service_password', 'dashboard_template', '/public/js/administration_change_service_password.js', false);
    }
}
