...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="POST" name="send_restrictions_form">
                    <fieldset class="mb-3">
                        <div style="color: red;margin-bottom:5px;font-size:16px;">*توجه:با ویرایش هرکدام از دسترسی ها تمام دسترسی های قبلی کاربر حذف و دسترسی های جدید جایگزین میشوند بنابراین در انتخاب خود وقت فرمایید.</div>
                        <legend class="text-uppercase font-size-sm font-weight-bold">تعریف دسترسی</legend>
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">نماینده</label>
                            <div class="col-lg-4">
                                <select class="form-control form-control-lg custom_select" name="branch" id="branch">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control form-control-lg" multiple="multiple" name="menu_access[]" id="menu_access" style="margin 15px !important;">
                    ...
                    <div class="text-right">
                        <button type="submit" name="send_restrictions" class="btn btn-primary" id="send_restrictions_btn">ارسال <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
        </div>
