                ...
                <div class="card-body">
                    ...
                    <input type="hidden" id="id" class="form-control" name="id" value="empty">
                        <fieldset class="mb-3">
                            ...
                            <legend class="text-uppercase font-size-sm font-weight-bold text-danger">پیش ثبت نام مشترکین حقوقی</legend>
                        ...
                        <div class="text-right">
                            <button type="submit" name="send_pre_internal_legal_subscribers" class="btn btn-primary" onsubmit="resetId()">ارسال <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
