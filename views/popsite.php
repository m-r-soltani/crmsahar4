            ...
            <form action="" method="POST">
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="ertefa_sakhteman" id="ertefa_sakhteman" placeholder="فقط عدد">
                        </div>
                        
                        <label class="col-form-label col-lg-2">ارتفاع دکل</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="ertefa_dakal" id="ertefa_dakal" placeholder="فقط عدد">
                        </div>
                        
                        <label class="col-form-label col-lg-2">مجموع ارتفاع</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="majmoe_ertefa" id="majmoe_ertefa" placeholder="فقط عدد">
                        </div>
                        
                        <label class="col-form-label col-lg-2">طول جغرافیایی (E)</label>
                        <div class="col-lg-4">
                            <input type="text" step="any" class="form-control" name="tol_joghrafiai" id="tol_joghrafiai" placeholder="فقط عدد">
                        </div>
                        
                        <label class="col-form-label col-lg-2">عرض جغرافیایی (N)</label>
                        <div class="col-lg-4">
                            <input type="text" step="any" class="form-control" name="arz_joghrafiai" id="arz_joghrafiai" placeholder="فقط عدد">
                        </div>
                        
                        <label class="col-form-label col-lg-2">شماره ثبت دکل</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="shomare_sabt" id="shomare_sabt" placeholder="مثال: 12345" required>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="maleke_dakal" id="maleke_dakal" placeholder="">
                        </div>
                        
                        <label class="col-form-label col-lg-2">شماره تماس مالک</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="shomare_tamas_malek" id="shomare_tamas_malek" placeholder="">
                        </div>
