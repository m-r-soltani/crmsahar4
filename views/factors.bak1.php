    ...
    <div class="content">
        ...
        <div class="card" id="st_tab_boxes">
            <div class="card-body factors_tab1 col-lg-12">
                ...
                <div class="init_boxes" id="pardakhtha_box">پرداخت ها</div>
                <div class="init_boxes" id="moshkelat_box">مشکلات</div>
                <div class="init_boxes" id="tamasha_box">تماس</div>
            </div>
        </div>
        <!--1st tabs-->
        <!--2nd tabs-->
        ...
        <div class="card" id="ekhtesase_emkanat_tab">
            <div class="card-body">
                <div class="col-lg-2" style="position: relative;float: right;display: inline">
                    <label for="asd">انتخاب سرویس:</label>
                    <ul class="ekhtesase_emkanat_serviceslist" id="ekhtesase_emkanat_serviceslist">

                    </ul>
                </div>
                <form action="#" method="POST" name="ekhtesase_emkanat_form">
                    <input type="hidden" name="ekhtesase_emkanat_user_id" id="ekhtesase_emkanat_user_id" value="empty">
                        <fieldset class="mb-3">
                            <legend class="text-uppercase font-size-sm font-weight-bold">امکانات</legend>
                            <div class="form-group row" style="position: relative;">
                                <label class="col-form-label col-lg-2">تلفن مورد تقاضا</label>
                                <div class="col-lg-4">
                                    <select class="form-control form-control-lg custom_select" name="ekhtesase_emkanat_telephone_morede_taghaza" id="ekhtesase_emkanat_telephone_morede_taghaza">
                                    </select>
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">مرکز مخابراتی</label>
                                <div class="col-lg-4">
                                    <select class="form-control form-control-lg custom_select" name="ekhtesase_emkanat_name_markaz" id="ekhtesase_emkanat_name_markaz" disabled>
                                    </select>
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">تیغه</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="ekhtesase_emkanat_tighe" id="ekhtesase_emkanat_tighe" disabled>
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">ردیف</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="ekhtesase_emkanat_radif" id="ekhtesase_emkanat_radif" disabled>
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">اختصاص اتصال</label>
                                <div class="col-lg-4">
                                    <select class="form-control form-control-lg custom_select" name="ekhtesase_emkanat_ekhtesase_port" id="ekhtesase_emkanat_ekhtesase_port">
                                    </select>
                                </div>
                                <br><br>
                        ...
                        <div class="text-right">
                            <button type="submit" name="send_ekhtesase_emkanat_adsl_vdsl" class="btn btn-primary">تایید<i class="icon-paperplane ml-2"></i></button>
                        </div>
                </form>
            </div>
        </div>
